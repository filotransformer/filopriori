...
Table~S1 in the supplementary material presents the per-project APFD for
\filopriori{} and the five deep learning baselines across all 20 RTPTorrent
projects.

% [Table moved to supplementary material -- see Table S1]
...
% [Table moved to supplementary material -- see Table S2]
...
in fold $k$. Table~S3 in the supplementary material presents the per-project
results.

% [Table moved to supplementary material -- see Table S3]
...
Table~S4 in the supplementary material summarizes the results. We note that this
...
% [Table moved to supplementary material -- see Table S4]
...
Table~S5 in the supplementary material presents the results.

% [Table moved to supplementary material -- see Table S5]
